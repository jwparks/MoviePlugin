...
public class HardTutorialStart implements CommandExecutor {
    ...
    private final List<Block> hard_tutorial_blocks = getHardBlocks();
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            Block reference_block = Objects.requireNonNull(getServer().getWorld("world")).getBlockAt(474, 70, -256);
            ...
            Hard_flag.setType(Material.STONE);
